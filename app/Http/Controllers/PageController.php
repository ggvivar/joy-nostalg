...
{     
  $items = [
    ['img_url' => asset('img/Photos/homepage/carousel/1.png'),
    'header' => "Home the Homeless, Power the Powerless, Love the Loveleast",
    'content' => "",
],
['img_url' => asset('img/Photos/homepage/carousel/2.png'),
'header' => "Slide 2",
'content' => "**insert text here**",
],
['img_url' => asset('img/Photos/homepage/carousel/3.png'),
'header' => "Slide 3",
'content' => "**insert text here**",
],
['img_url' => asset('img/Photos/homepage/carousel/4.png'),
'header' => "Slide 4",
'content' => "**insert text here**",
],
['img_url' => asset('img/Photos/homepage/carousel/5.png'),
'header' => "Slide 5",
'content' => "**insert text here**",
],
['img_url' => asset('img/Photos/homepage/carousel/6.png'),
'header' => "Slide 6",
'content' => "**insert text here**",
],
['img_url' => asset('img/Photos/homepage/carousel/7.png'),
'header' => "Slide 7",
'content' => "**insert text here**",
]
];
